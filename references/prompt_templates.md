...
- 公司必须真实存在且与所在环节匹配
- 三层不能有重复环节，边界清晰
- ⚠️ **跨层公司唯一性**：一家公司在整个产业链中只能出现在**一层**。即便它业务横跨上中下游（如光伏的隆基/晶科/通威、AI 的微软/谷歌、半导体的三星），也必须按以下原则只放一层：
  1. 看营收占比：哪一层 >50% 营收 → 归哪一层
  2. 看市场地位：哪一层全球/全国份额最高 → 归哪一层
  3. 看战略叙事：财报和投资者沟通中主动强调的"主业标签"
  4. 避让原则：两层都关键时，优先放在公司更稀缺的那一层
- ⚠️ **正例参考**：通威=上游硅料；隆基=中游组件；阳光电源=下游储能；华为=中游逆变器
- ⚠️ **反例禁止**：通威同时出现在硅料+电池片；三星同时出现在晶圆代工+HBM；Shutterstock 同时出现在训练数据+广告创意
- 每个 segment 仍要求 4-5 家真实公司，不能因唯一性导致细分变薄
- 只输出纯净 JSON
